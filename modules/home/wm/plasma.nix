{ pkgs, inputs, ... }:
{
  ...
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "kwin"."Switch One Desktop Up" = "none,,Switch One Desktop Up";
      ...
      "kwin"."Window Fullscreen" = "none,none,Make Window Fullscreen";
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."2c0bab25-f4f2-4ade-81d8-2a2a27c116ab" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "2c0bab25-f4f2-4ade-81d8-2a2a27c116ab";
      ...
      "kwinrc"."Desktops"."Id_1" = "e5d4d43d-2255-4a1f-a880-3fbfcf660508";
      "kwinrc"."Desktops"."Id_2" = "9e16172c-035c-4f85-b87f-4aaa03074fce";
      "kwinrc"."Desktops"."Id_3" = "3d343585-20a4-4c11-ba6d-28a385db5b3b";
      "kwinrc"."Desktops"."Id_4" = "6542bca0-c071-46fb-a3f7-712ca48f62ae";
      "kwinrc"."Desktops"."Id_5" = "9033a747-e0d4-41a4-860a-ca108a44f7f4";
      "kwinrc"."Desktops"."Id_6" = "f7f12ccb-5503-4486-b86e-f60d4c2a4fcc";
